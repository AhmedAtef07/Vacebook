...
emojiApp.config(["$sceProvider", function(a) {
        ...
        $.emojiarea.spritesheetPath = "assets/images/img/emojisprite_!.png", $.emojiarea.spritesheetDimens = Config.EmojiCategorySpritesheetDimens, $.emojiarea.iconSize = 20, $.emojiarea.icons = i, $.emojiarea.reverseIcons = j
        ...
        function e(b, e, f) {
            ...
            function j(a) {
                ...
                } else if (d && !d.match(/assets\/images\/img\/blank\.gif/)) {
    ...
    function(a, b, c) {
        ...
        k.prototype.setup = function() {
            ...
            return o += "width:" + i + "px;", o += "height:" + i + "px;", o += "background:url('" + h.replace("!", d) + "') " + k + "px " + l + "px no-repeat;", o += "background-size:" + m + "px " + n + "px;", '<img src="assets/images/img/blank.gif" class="img" style="' + o + '" alt="' + j.htmlEntities(g) + '">'
